import{l as ae}from"./helpers-DXE-UcnP.js";import"./WebMaster-CULuADx0.js";import"./MeuComponenteVanilla-DuG7ZvNz.js";import"./PopoverApi-CtVSCr_s.js";import"./WindowManagementApi-DbEFscGw.js";import"./SignedOut-CBnj7iGE.js";import"./index-nuYtCEEu.js";import"./iframe-CQoxeWFO.js";class re extends HTMLElement{static{this.tag="mozg-simple-css-waves"}constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.css(),this.html(),this.js()}disconnectedCallback(){if(this.shadowRoot)for(;this.shadowRoot.firstChild;)this.shadowRoot.removeChild(this.shadowRoot.firstChild)}static get observedAttributes(){return["mode"]}attributeChangedCallback(e,t,o){}adoptedCallback(){}css(){const e=document.createElement("style");e.textContent=`
