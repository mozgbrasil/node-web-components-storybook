import{l as ae}from"./helpers-DXE-UcnP.js";import"./WebMaster-DUK5bV_G.js";import"./MeuComponenteVanilla-DuG7ZvNz.js";import"./PopoverApi-BQ9YlHyL.js";import"./WindowManagementApi-DRnzi_VN.js";import"./SignedOut-DXwF6Pio.js";import"./index-nuYtCEEu.js";import"./iframe-BK6HzFne.js";class re extends HTMLElement{static{this.tag="mozg-simple-css-waves"}constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.css(),this.html(),this.js()}disconnectedCallback(){if(this.shadowRoot)for(;this.shadowRoot.firstChild;)this.shadowRoot.removeChild(this.shadowRoot.firstChild)}static get observedAttributes(){return["mode"]}attributeChangedCallback(e,t,o){}adoptedCallback(){}css(){const e=document.createElement("style");e.textContent=`
