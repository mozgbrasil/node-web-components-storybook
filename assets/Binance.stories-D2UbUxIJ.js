import{l as z}from"./helpers-DXE-UcnP.js";class M{constructor(e,t,r){this.next=r,r&&(r.prev=this),this.prev=t,t&&(t.next=this),this.data=e}}class B{constructor(){this._length=0}get head(){return this._head&&this._head.data}get tail(){return this._tail&&this._tail.data}get current(){return this._current&&this._current.data}get length(){return this._length}push(e){this._tail=new M(e,this._tail),this._length===0&&(this._head=this._tail,this._current=this._head,this._next=this._head),this._length++}pop(){var e=this._tail;if(this._length!==0)return this._length--,this._length===0?(this._head=this._tail=this._current=this._next=void 0,e.data):(this._tail=e.prev,this._tail.next=void 0,this._current===e&&(this._current=this._tail,this._next=void 0),e.data)}shift(){var e=this._head;if(this._length!==0)return this._length--,this._length===0?(this._head=this._tail=this._current=this._next=void 0,e.data):(this._head=this._head.next,this._current===e&&(this._current=this._head,this._next=this._current.next),e.data)}unshift(e){this._head=new M(e,void 0,this._head),this._length===0&&(this._tail=this._head,this._next=this._head),this._length++}unshiftCurrent(){var e=this._current;return e===this._head||this._length<2?e&&e.data:(e===this._tail?(this._tail=e.prev,this._tail.next=void 0,this._current=this._tail):(e.next.prev=e.prev,e.prev.next=e.next,this._current=e.prev),this._next=this._current.next,e.next=this._head,e.prev=void 0,this._head.prev=e,this._head=e,e.data)}removeCurrent(){var e=this._current;if(this._length!==0)return this._length--,this._length===0?(this._head=this._tail=this._current=this._next=void 0,e.data):(e===this._tail?(this._tail=e.prev,this._tail.next=void 0,this._current=this._tail):e===this._head?(this._head=e.next,this._head.prev=void 0,this._current=this._head):(e.next.prev=e.prev,e.prev.next=e.next,this._current=e.prev),this._next=this._current.next,e.data)}resetCursor(){return this._current=this._next=this._head,this}next(){var e=this._next;if(e!==void 0)return this._next=e.next,this._current=e,e.data}}class O extends B{constructor(e,t,r,s){if(super(),this.size=e,this.maintainHigh=t,this.maintainLow=r,this.maintainSum=s,this.totalPushed=0,this.periodHigh=0,this.periodLow=1/0,this.periodSum=0,!e||typeof e!="number")throw"Size required and should be a number.";this._push=this.push,this.push=function(a){this.add(a),this.totalPushed++}}add(e){this.length===this.size?(this.lastShift=this.shift(),this._push(e),this.maintainHigh&&this.lastShift==this.periodHigh&&this.calculatePeriodHigh(),this.maintainLow&&this.lastShift==this.periodLow&&this.calculatePeriodLow(),this.maintainSum&&(this.periodSum=this.periodSum-this.lastShift)):this._push(e),this.maintainHigh&&this.periodHigh<=e&&(this.periodHigh=e),this.maintainLow&&this.periodLow>=e&&(this.periodLow=e),this.maintainSum&&(this.periodSum=this.periodSum+e)}*iterator(){for(this.resetCursor();this.next();)yield this.current}calculatePeriodHigh(){for(this.resetCursor(),this.next()&&(this.periodHigh=this.current);this.next();)this.periodHigh<=this.current&&(this.periodHigh=this.current)}calculatePeriodLow(){for(this.resetCursor(),this.next()&&(this.periodLow=this.current);this.next();)this.periodLow>=this.current&&(this.periodLow=this.current)}}let j={};function H(l){return j[l]}function q(l){let e=H("precision");return e?parseFloat(l.toPrecision(e)):l}class m{constructor(e){this.format=e.format||q}static reverseInputs(e){e.reversedInput&&(e.values&&e.values.reverse(),e.open&&e.open.reverse(),e.high&&e.high.reverse(),e.low&&e.low.reverse(),e.close&&e.close.reverse(),e.volume&&e.volume.reverse(),e.timestamp&&e.timestamp.reverse())}getResult(){return this.result}}class x extends m{constructor(e){super(e),this.period=e.period,this.price=e.values;var t=(function*(r){var s=new B,a=0,n=1,o=yield,i;for(s.push(0);;)n<r?(n++,s.push(o),a=a+o):(a=a-s.shift()+o,i=a/r,s.push(o)),o=yield i});this.generator=t(this.period),this.generator.next(),this.result=[],this.price.forEach(r=>{var s=this.generator.next(r);s.value!==void 0&&this.result.push(this.format(s.value))})}nextValue(e){var t=this.generator.next(e).value;if(t!=null)return this.format(t)}}x.calculate=G;function G(l){m.reverseInputs(l);var e=new x(l).result;return l.reversedInput&&e.reverse(),m.reverseInputs(l),e}class A extends m{constructor(e){super(e);var t=e.period,r=e.values,s=2/(t+1),a;this.result=[],a=new x({period:t,values:[]});var n=(function*(){for(var o=yield,i;;)i!==void 0&&o!==void 0?(i=(o-i)*s+i,o=yield i):(o=yield,i=a.nextValue(o),i&&(o=yield i))});this.generator=n(),this.generator.next(),this.generator.next(),r.forEach(o=>{var i=this.generator.next(o);i.value!=null&&this.result.push(this.format(i.value))})}nextValue(e){var t=this.generator.next(e).value;if(t!=null)return this.format(t)}}A.calculate=U;function U(l){m.reverseInputs(l);var e=new A(l).result;return l.reversedInput&&e.reverse(),m.reverseInputs(l),e}class $ extends m{constructor(e){super(e);var t=e.SimpleMAOscillator?x:A,r=e.SimpleMASignal?x:A,s=new t({period:e.fastPeriod,values:[],format:i=>i}),a=new t({period:e.slowPeriod,values:[],format:i=>i}),n=new r({period:e.signalPeriod,values:[],format:i=>i}),o=this.format;this.result=[],this.generator=(function*(){for(var i=0,c,d,h,g,p,u;;){if(i<e.slowPeriod){c=yield,p=s.nextValue(c),u=a.nextValue(c),i++;continue}p&&u&&(d=p-u,h=n.nextValue(d)),g=d-h,c=yield{MACD:o(d),signal:h?o(h):void 0,histogram:isNaN(g)?void 0:o(g)},p=s.nextValue(c),u=a.nextValue(c)}})(),this.generator.next(),e.values.forEach(i=>{var c=this.generator.next(i);c.value!=null&&this.result.push(c.value)})}nextValue(e){var t=this.generator.next(e).value;return t}}$.calculate=W;function W(l){m.reverseInputs(l);var e=new $(l).result;return l.reversedInput&&e.reverse(),m.reverseInputs(l),e}class D extends m{constructor(e){super(e);let t=e.values,r=e.period,s=this.format;this.generator=(function*(a){var n=yield,o=1,i=0,c,d,h=n;for(n=yield;;)d=n-h,d=d>0?d:0,d>0&&(i=i+d),o<a?o++:c===void 0?c=i/a:c=(c*(a-1)+d)/a,h=n,c=c!==void 0?s(c):void 0,n=yield c})(r),this.generator.next(),this.result=[],t.forEach(a=>{var n=this.generator.next(a);n.value!==void 0&&this.result.push(n.value)})}nextValue(e){return this.generator.next(e).value}}D.calculate=K;function K(l){m.reverseInputs(l);var e=new D(l).result;return l.reversedInput&&e.reverse(),m.reverseInputs(l),e}class E extends m{constructor(e){super(e);let t=e.values,r=e.period,s=this.format;this.generator=(function*(a){var n=yield,o=1,i=0,c,d,h=n;for(n=yield;;)d=h-n,d=d>0?d:0,d>0&&(i=i+d),o<a?o++:c===void 0?c=i/a:c=(c*(a-1)+d)/a,h=n,c=c!==void 0?s(c):void 0,n=yield c})(r),this.generator.next(),this.result=[],t.forEach(a=>{var n=this.generator.next(a);n.value!==void 0&&this.result.push(n.value)})}nextValue(e){return this.generator.next(e).value}}E.calculate=Y;function Y(l){m.reverseInputs(l);var e=new E(l).result;return l.reversedInput&&e.reverse(),m.reverseInputs(l),e}class L extends m{constructor(e){super(e);var t=e.period,r=e.values,s=new D({period:t,values:[]}),a=new E({period:t,values:[]});this.generator=(function*(n){for(var o=yield,i,c,d,h;;)i=s.nextValue(o),c=a.nextValue(o),i!==void 0&&c!==void 0&&(c===0?h=100:i===0?h=0:(d=i/c,d=isNaN(d)?0:d,h=parseFloat((100-100/(1+d)).toFixed(2)))),o=yield h})(),this.generator.next(),this.result=[],r.forEach(n=>{var o=this.generator.next(n);o.value!==void 0&&this.result.push(o.value)})}nextValue(e){return this.generator.next(e).value}}L.calculate=J;function J(l){m.reverseInputs(l);var e=new L(l).result;return l.reversedInput&&e.reverse(),m.reverseInputs(l),e}class k extends m{constructor(e){super(e);var t=e.period,r=e.values,s=new x({period:t,values:[],format:a=>a});this.result=[],this.generator=(function*(){var a,n,o=new O(t);a=yield;for(var i;;){if(o.push(a),n=s.nextValue(a),n){let c=0;for(let d of o.iterator())c=c+Math.pow(d-n,2);i=Math.sqrt(c/t)}a=yield i}})(),this.generator.next(),r.forEach(a=>{var n=this.generator.next(a);n.value!=null&&this.result.push(this.format(n.value))})}nextValue(e){var t=this.generator.next(e);if(t.value!=null)return this.format(t.value)}}k.calculate=Z;function Z(l){m.reverseInputs(l);var e=new k(l).result;return l.reversedInput&&e.reverse(),m.reverseInputs(l),e}class P extends m{constructor(e){super(e);var t=e.period,r=e.values,s=e.stdDev,a=this.format,n,o;this.result=[],n=new x({period:t,values:[],format:i=>i}),o=new k({period:t,values:[],format:i=>i}),this.generator=(function*(){var i,c,d,h;for(c=yield;;){if(d=n.nextValue(c),h=o.nextValue(c),d){let g=a(d),p=a(d+h*s),u=a(d-h*s),f=a((c-u)/(p-u));i={middle:g,upper:p,lower:u,pb:f}}c=yield i}})(),this.generator.next(),r.forEach(i=>{var c=this.generator.next(i);c.value!=null&&this.result.push(c.value)})}nextValue(e){return this.generator.next(e).value}}P.calculate=Q;function Q(l){m.reverseInputs(l);var e=new P(l).result;return l.reversedInput&&e.reverse(),m.reverseInputs(l),e}function N(l){if(!l||!Array.isArray(l)||l.length===0)return console.warn("Dados inválidos para análise técnica"),[];try{const e=l.map(y=>{const C=typeof y.c=="number"?y.c:parseFloat(y.c);if(isNaN(C))throw new Error("Preço de fechamento inválido encontrado");return C}),t=9,r=21,s=14,a=20,n=x.calculate({period:t,values:e})||[],o=x.calculate({period:r,values:e})||[],i=L.calculate({period:s,values:e})||[],c=$.calculate({fastPeriod:12,slowPeriod:26,signalPeriod:9,values:e})||[],d=P.calculate({period:a,stdDev:2,values:e})||[],h=l[l.length-1],g=parseFloat(h.c),p=i[i.length-1],u=c[c.length-1],f=d[d.length-1],v=[];let b="Neutro";typeof p=="number"&&(b=p>70?"Sobrecomprado":p<30?"Sobrevendido":"Neutro",v.push({indicator:"RSI",value:p.toFixed(2),signal:b,color:b==="Sobrecomprado"?"#ff4444":b==="Sobrevendido"?"#4CAF50":"#666666"}));let I="Neutro";u&&typeof u.MACD=="number"&&typeof u.signal=="number"?(I=u.MACD>u.signal?"Positivo":"Negativo",v.push({indicator:"MACD",value:`${u.MACD.toFixed(2)} | Signal: ${u.signal.toFixed(2)}`,signal:I,color:I==="Positivo"?"#4CAF50":"#ff4444"})):console.warn("Dados do MACD inválidos",u);let w="Dentro das bandas";f&&g&&(w=g>f.upper?"Sobrecomprado":g<f.lower?"Sobrevendido":"Dentro das bandas",v.push({indicator:"BB",value:`Preço: ${g.toFixed(2)} | Superior: ${f.upper.toFixed(2)} | Inferior: ${f.lower.toFixed(2)}`,signal:w,color:w==="Sobrecomprado"?"#ff4444":w==="Sobrevendido"?"#4CAF50":"#666666"}));let _="Neutro";if(n.length&&o.length){const y=n[n.length-1],C=o[o.length-1];_=y>C?"Alta":"Baixa",v.push({indicator:"SMA",value:`Curta: ${y.toFixed(2)} | Longa: ${C.toFixed(2)}`,signal:_,color:_==="Alta"?"#4CAF50":"#ff4444"})}const T=X(b,I,w,_);return{analysis:v,recommendation:T}}catch(e){return console.error("Erro na análise técnica:",e),[]}}function X(l,e,t,r){return l==="Sobrecomprado"||e==="Negativo"||t==="Sobrecomprado"||r==="Baixa"?"Vender ou esperar":l==="Sobrevendido"||e==="Positivo"||t==="Sobrevendido"||r==="Alta"?"Comprar":"Esperar"}window.analyzeCandles=N;class V extends HTMLElement{static{this.tag="mozg-binance"}constructor(){super(),this.attachShadow({mode:"open"}),this.API_CONFIG={baseUrls:{coins:"https://www.binance.com/bapi/apex/v1/public/apex/marketing/symbol/list",chart:"https://www.binance.com/bapi/composite/v1/public/promo/cmc/cryptocurrency/detail/chart",kline:"https://www.binance.com/api/v3/uiKlines"},timeRanges:["1D","7D","1M","3M","1Y","YTD"],klineIntervals:["1d","1w"]},this.autoIterating=!1,this.currentIterationIndex=0,this.charts={},this.db=null;const e={css:[],js:[{src:"https://cdn.jsdelivr.net/npm/luxon@3.4.4",onload:()=>{},onerror:()=>{console.error("Falha ao carregar Luxon!")}},{src:"https://cdn.jsdelivr.net/npm/chart.js@4.4.1/dist/chart.umd.js",onload:()=>{},onerror:()=>{console.error("Falha ao carregar Chart.js!")}},{src:"https://cdn.jsdelivr.net/npm/chartjs-adapter-luxon@1.3.1",onload:()=>{},onerror:()=>{console.error("Falha ao carregar Chartjs Adapter Luxon!")}},{src:"https://cdn.jsdelivr.net/npm/chartjs-chart-financial@0.2.0",onload:()=>{},onerror:()=>{console.error("Falha ao carregar Chartjs Chart Financial!")}},{src:"https://cdn.jsdelivr.net/npm/html2canvas",onload:()=>{},onerror:()=>{console.error("Falha ao carregar Html2Canvas!")}}]};z(this.shadowRoot,e).then(()=>{this.initDB().then(()=>{this.init()})}).catch(t=>{console.error("Erro ao carregar os recursos:",t)})}connectedCallback(){this.render()}disconnectedCallback(){for(;this.shadowRoot.firstChild;)this.shadowRoot.removeChild(this.shadowRoot.firstChild)}static get observedAttributes(){return["element"]}attributeChangedCallback(e,t,r){}adoptedCallback(){}render(){let e="";e+=`
